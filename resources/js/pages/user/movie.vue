<template>
  <div class="container">
    <div class="card card-default">
      <div class="card-header">Search movie, series, episode</div>
      <div class="card-body">
        <div class="filter-container">
          <div class="filter-form">
            <div class="filter-item">
              <label for="movieName" class="filter-label">Movie Name</label>
              <input 
                v-model="name" 
                type="text" 
                id="movieName"
        ...
        <div
          ...
          <div class="movie-grid">
            <div 
              ...
              <div href="#" class="favorite-button"
                @click="toggleFavorite(movie.imdbID, $event)">
          ...
          <div v-if="!hasMore && !loading">No more movies to load</div>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    async toggleFavorite(imdbID, event) {
      event.stopPropagation();
      try {
        await this.$store.dispatch('movie/toggleFavorite', imdbID);
        this.movie;
